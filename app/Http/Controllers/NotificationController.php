...
class NotificationController extends Controller
{
    ...
    {
        $data = Notification::all()->sortBy('created_at');
    ...
    // public function deleteAllNotification(Notification $notification)
    // {
    //     $data = $notification->where('user_id', auth()->user()->id)->get();
    //     if (!$data) return $this->responseFailed('Data not found', '', 404);
    //     $data->delete();
    //     return $this->responseSuccess('All Notification Deleted', '', 200);
    // }
}
